                    ...
                    <Box sx={{display: "flex", flexDirection: 'column', width: "100%", backgroundColor: "tran", marginBottom: 5}}>
                        ...
                        <Text variant='muted' sx={{marginLeft: "20px", fontSize: "18px"}}>
                            Basically i am good with any thing based on Javascript en term of experince but,
                             I do belive that I do have a good understanding of the philosophy behind giving orders 
                             to the computer and problem solving, I can adopte
                        </Text>
                        ...
                        I can be integrated silently in any tech community. I would really aprciate having time for study and swimming
                        </Text>
                    </Box>
            </Box>
        </Box>
